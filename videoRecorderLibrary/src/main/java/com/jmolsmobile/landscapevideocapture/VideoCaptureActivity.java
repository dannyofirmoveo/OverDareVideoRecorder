...
public class VideoCaptureActivity extends Activity implements RecordingButtonInterface, VideoRecorderInterface {
    ...
    public void onRecordingStarted() {
        ...
        // Timer
        final TextView timerTextView = (TextView) findViewById(R.id.textViewTimerDisplay);

                countDownTimer = new CountDownTimer(mCaptureConfiguration.getMaxCaptureDuration(), 1000) {
                    @Override
                    public void onTick(long millisUntilFinished) {

                        String sec = (int)millisUntilFinished/1000 + "s";
                        timerTextView.setText(sec);
